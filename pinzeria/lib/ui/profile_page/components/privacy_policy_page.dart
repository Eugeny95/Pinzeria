          ...
          child: Container(
            ...
            child: ListView(
                ...
                children: [
                  ...
                  Padding(padding: EdgeInsets.only(top: height * 0.01)),
                  Text(
                      '1.5. Настоящая Политика применяется в отношении персональных данных, которые могут быть получены от Субъекта персональных данных Оператором посредством регистрации, авторизации, оформления заказа Субъектом персональных данных на сайтеpinzeria-vrn.ru и/или мобильном приложении pinzeria.'),
                  Padding(padding: EdgeInsets.only(top: height * 0.01)),
                  Text(
